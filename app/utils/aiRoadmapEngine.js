...
`;
    ...
    try {
        ...
        return {
            roadmap: [
                { step: 1, title: "Review Fundamentals", description: "Go back to basics to ensure a strong foundation.", duration: "1 week", status: "pending" },
                { step: 2, title: "Consistent Practice", description: "Dedicate 30 mins daily to study sessions.", duration: "Ongoing", status: "pending" },
                { step: 3, title: "Engage with Peers", description: "Join 2 group discussions this week.", duration: "1 week", status: "pending" },
                { step: 4, title: "Take Initiative", description: "Ask one question in every class.", duration: "Ongoing", status: "pending" },
                { step: 5, title: "Assess Progress", description: "Review your progress and adjust goals.", duration: "1 day", status: "pending" }
            ]
        };
    }
}
