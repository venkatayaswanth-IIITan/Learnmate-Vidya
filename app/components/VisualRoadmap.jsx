                ...
                {roadmapData.roadmap.map((step, index) => {
                    ...
                    return (
                        <div key={index} className="relative flex items-start gap-6">
                            ...
                            {/* Content Card */}
                            <div
                                className={`flex-1 p-5 rounded-2xl border transition-all duration-300 cursor-pointer ${isCompleted
                            ...
                            >
                                <div className="flex justify-between items-start mb-2">
                                    <div>
                                        <span className={`text-xs font-bold uppercase tracking-wider mb-1 block ${isCompleted ? 'text-green-600' : isNext ? 'text-indigo-500' : 'text-slate-400'
                                            }`}>
